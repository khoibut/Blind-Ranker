function CreateEntry({number}: {number: string | number}) {
    return (
        <div className="border-gray-500 border-1 box-border h-20 rounded-2xl gap-10 flex items-center">
            ...
            <div className="text-xl">
                <input placeholder="Type here..." className="text-gray-100 text-xl w-90 border-gray-100 border-1 px-4 py-2 rounded-xl" />
            </div>
            <div className="text-gray-100 text-6xl select-none hover:cursor-pointer">
                -
            </div>
        </div>
    )
